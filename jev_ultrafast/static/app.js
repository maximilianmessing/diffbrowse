...
let state = null,
  ...
  automatic = false;
const goals = {
  flights: 'Find one-way flights from Zurich to London on September 27, 2026, for one adult in economy. Stop when matching flight options are visible. Do not select or book a flight.',
...
function render() {
  ...
  const labels = {
    ...
    done: "DiffBrowse reports complete · inspect the page",
  ...
  $("ranking-note").textContent = d ? "Ranked by DiffBrowse" : "Unranked";
...
$("choose").addEventListener("click", () =>
  perform(() => call("predict"), "DiffBrowse is evaluating actions…"),
);
...
$("download").addEventListener("click", () => {
  ...
  a.href = url;
  a.download = "diffbrowse-trace.json";
  a.click();
